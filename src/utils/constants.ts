...
export const ResponseCodes = {
    ...
    SUB_BUILDING_CREATED: { code: 2011, message: "Sub Building created successfully" },
    SUB_BUILDING_LIST: { code: 2012, message: "Sub Building list fetched successfully" },
    SUB_BUILDING_DETAILS: { code: 2013, message: "Sub Building details fetched successfully" },
    SUB_BUILDING_UPDATED: { code: 2014, message: "Sub Building updated successfully" },
    SUB_BUILDING_DELETED: { code: 2015, message: "Sub Building deleted successfully" },
    ...
    SERVICE_DETAILS: { code: 3003, message: "Service details fetched successfully" },
    ...
    SUB_SERVICE_CREATED: { code: 3011, message: "Sub Service created successfully" },
    SUB_SERVICE_LIST: { code: 3012, message: "Sub Service list fetched successfully" },
    SUB_SERVICE_DETAILS: { code: 3013, message: "Sub Service details fetched successfully" },
    SUB_SERVICE_UPDATED: { code: 3014, message: "Sub Service updated successfully" },
    SUB_SERVICE_DELETED: { code: 3015, message: "Sub Service deleted successfully" },
    ...
    ACTION_DETAILS: { code: 3023, message: "Action details fetched successfully" },
    ...
    PRODUCT_DETAILS: { code: 4003, message: "Product details fetched successfully" },
