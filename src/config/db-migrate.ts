...
const migrateBuildingAndSubBuildings = async () => {
      ...
      subBuildings: [
        {
          ...
          description:
            "Primary building for passenger services in elevated metro stations.",
          levels: [
            {
              name: "Ground Floor",
              description:
                "Entry/exit points, ticket counters, and basic amenities.",
              rooms: [
                {
                  name: "PUMP ROOM",
            ...
            },
            {
              name: "Concourse",
              description:
                "Passenger waiting areas, ticket validation, and shops.",
              rooms: [
                {
                  name: "SCR ROOM",
            ...
            },
            {
              name: "Platform",
              description:
                "Boarding and alighting of trains with safety measures.",
              rooms: [
                {
            ...
            },
            {
              name: "Roof",
              description:
                "Covers and protects the platform; may include solar panels.",
            },
          ],
        },
        {
          ...
          levels: [
            {
              name: "DG Room",
              description:
                "Room for the diesel generator providing backup power.",
            },
            {
              name: "Pump Room",
              description:
                "Manages water pumping systems for station operations.",
            },
          ],
        },
        {
          ...
          levels: [
            {
              name: "Ground Floor",
              description:
                "Open or covered parking for two-wheelers and four-wheelers.",
            },
            {
              name: "First Floor",
              description:
                "Additional parking space with ramps or lifts for vehicles.",
            },
          ],
        },
      ],
      ...
      subBuildings: [
        {
          type: "Station Building",
          description:
            "Main structure for passenger services in underground metro stations.",
          levels: [
            {
              name: "Ground Floor",
              description:
                "Surface-level facilities, entry/exit to the station.",
              rooms: [
                {
                  name: "PUMP ROOM",
                  description: "PUMP ROOM",
            ...
            },
            {
              name: "Platform",
              description:
                "Subterranean boarding/alighting of trains with safety features.",
              rooms: [
                {
                  name: "PLATFORM AREA-01",
                  description: "PLATFORM AREA-01",
            ...
            },
            {
              name: "Undercroft",
              description:
                "Storage, service areas, and technical installations.",
            },
          ],
        },
        {
          ...
          description:
            "Support structure for operational and technical systems.",
          levels: [
            {
              name: "DG Room",
            ...
            },
            {
              name: "Water Tank",
              description:
                "Storage for firefighting or operational water needs.",
            },
            {
              name: "First Floor",
        ...
        },
        {
          ...
          description:
            "Space for utilities like electrical, telecom, or drainage systems.",
          levels: [
            {
    ...
    },
    {
      ...
      subBuildings: [
        ...
        },
        {
          type: "ASS Room",
          description:
            "Auxiliary Sub-Station for electrical supply management.",
          levels: [
            {
              name: "Ground Floor",
          ...
          levels: [
            {
              name: "Ground Floor",
              description:
                "Manages electric traction systems for train movement.",
              rooms: [
                {
                  name: "ETU ROOM",
        ...
        },
        {
          ...
          description:
            "Tracks employee attendance and handles security operations.",
          levels: [
            {
              name: "Ground Floor",
  ...
  try {
    ...
    const buildingArray = updatedBuildings.reduce<
      { type: string; id: Types.ObjectId }[]
    >((array, building) => {
    ...
    const subBuildingResult = await SubBuilding.bulkWrite(
      subBuildingOperations
    );
    ...
    const subBuildingArray = updatedSubBuildings.reduce<
      { type: string; id: Types.ObjectId; buildingId: Types.ObjectId }[]
    >((array, subBuilding) => {
      array.push({
        id: subBuilding.id,
      ...
      if (building.subBuildings) {
        building.subBuildings.forEach((subBuilding) => {
          ...
          const subBuildingId = subBuildingArray.find((subBuildingItem) => {
            const matchedBuildingData = updatedBuildings.find(
              (buildingItem) =>
                buildingItem.id === subBuildingItem.buildingId.toString()
            );
            return (
              subBuildingItem.type === subBuilding.type &&
              matchedBuildingData?.type === building.type
            );
          })?.id;
            ...
            subBuilding.levels.forEach((level) => {
              levelOperations.push({
                updateOne: {
                  ...
                  update: {
                    $set: { ...level, sub_building_id: subBuildingId },
                  },
                  upsert: true,
                },
              });
    ...
    const levelArray = updatedLevels.reduce<
      { name: string; id: Types.ObjectId; subBuildingId: Types.ObjectId }[]
    >((array, level) => {
      array.push({
        id: level.id,
        name: level.name,
        subBuildingId: level.sub_building_id,
      });
      return array;
    }, []);
          ...
          if (subBuilding.levels) {
            subBuilding.levels.forEach((level) => {
              const levelId = levelArray.find((levelItem) => {
                const matchedSubBuildingData = updatedSubBuildings.find(
                  (subBuildingItem) =>
                    subBuildingItem.id === levelItem.subBuildingId.toString()
                );
                return (
                  levelItem.name === level.name &&
                  matchedSubBuildingData?.type === subBuilding.type
                );
              })?.id;
...
const migrateServiceAndSubServices = async () => {
  try {
    ...
    const servicesData = [
      {
        name: "Electrical",
        description:
          "Electrical services including lighting, power, and equipment setup.",
        image: "electrical.jpg",
        subServices: [
          {
            name: "Lighting",
            description:
              "Services related to lighting systems and installations.",
            image: "lighting.jpg",
          },
          {
            name: "Power",
            description: "Services related to power supply and distribution.",
            image: "power.jpg",
          },
          {
            name: "Equipment",
            description: "Installation and management of electrical equipment.",
            image: "equipment.jpg",
          },
          {
            name: "Containment",
            description: "Cable containment systems and related services.",
            image: "containment.jpg",
          },
          {
            name: "Earthing",
            description: "Services for earthing and grounding systems.",
            image: "earthing.jpg",
          },
          {
            name: "Fire Detection",
            description: "Fire detection systems and installations.",
            image: "fire_detection.jpg",
          },
        ],
      },
      {
        ...
        subServices: [
          {
            ...
            description: "Services for chilled water systems.",
            image: "chilled_water.jpg",
          },
          {
            name: "VRF / VRV",
            description: "Variable Refrigerant Flow and Volume systems.",
            image: "vrf_vrv.jpg",
          },
          {
            name: "Direct Expansion",
            description: "Direct expansion HVAC systems.",
            image: "direct_expansion.jpg",
          },
          {
            name: "Ventilation",
            description: "Ventilation systems and installations.",
      ...
      },
      {
        name: "Fire Fighting",
        description:
          "Fire fighting services including hydrant and sprinkler systems.",
        image: "fire_fighting.jpg",
        subServices: [
          {
            name: "Hydrant System",
            description: "Installation and management of hydrant systems.",
            image: "hydrant_system.jpg",
          },
          {
            name: "Sprinkler System",
            description: "Sprinkler systems for fire safety.",
            image: "sprinkler_system.jpg",
          },
          {
            name: "Fire Extinguisher",
            description: "Services related to fire extinguishers.",
      ...
      },
      {
        ...
        subServices: [
          {
            name: "Water Supply",
            description: "Services for water supply systems.",
            image: "water_supply.jpg",
          },
          {
            name: "Drainage",
            description: "Drainage systems and installations.",
            image: "drainage.jpg",
          },
        ],
      },
    ...
    const services = await Service.find({
      name: { $in: servicesData.map((s) => s.name) },
    });

    // Step 2: Prepare bulkWrite operations for SubServices
    const subServiceOps: any[] = [];
    services.forEach((service) => {
      const correspondingServiceData = servicesData.find(
